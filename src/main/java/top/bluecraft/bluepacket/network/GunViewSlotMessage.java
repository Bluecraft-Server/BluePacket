...
public class GunViewSlotMessage {
	...
	public GunViewSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public GunViewSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(GunViewSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap<String, Object> guistate = GunViewMenu.guistate;
